...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir",type=str,default="experiments/test_inpainting_tactile_231129_013830/results/test/0")
    ...
    parser.add_argument("--output_dir",type=str,default="results/taxim_m1_256/Palette/")
    ...
    for input_file in tqdm(input_file_list):
        ...
        cv2.imwrite(os.path.join(args.output_dir, os.path.splitext(input_file)[0]+".bmp"), img)
