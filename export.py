...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir",type=str,default="experiments/test_inpainting_tactile_240117_205107/results/test/0")
    ...
    parser.add_argument("--output_dir",type=str,default="dataset/slip/nail4/Palette")
    ...
    for input_file in tqdm(input_file_list):
        if os.path.splitext(input_file)[1] == args.save_fmt and not args.resize:
            shutil.copyfile(os.path.join(args.input_dir, input_file), os.path.join(args.output_dir, input_file))
        else:
