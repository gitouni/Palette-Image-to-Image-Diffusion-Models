...
def options():
    ...
    parser.add_argument("--gt_dir",type=str,default="dataset/taxim/asim_non_marker_256")
    parser.add_argument("--pred_dir",type=str,default="results/taxim_m1_256/Palette")
