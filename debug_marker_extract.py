...
import numpy as np
from utils.utils import find_marker_debug2
import shutil
import os
...
def options():
    ...
    io_parser.add_argument("--debug_dir",type=str,default="debug_mask_exception")
    io_parser.add_argument("--tgt_file",type=str,default="dataset/vitac/img/000000.jpg")
    marker_parser = parser.add_argument_group()
    marker_parser.add_argument("--diff_min",type=int,default=145)
...
if __name__ == "__main__":
    ...
    gray, im_blur_3, im_blur_8, im_blur_sub, blur_mask, mask, value, value_mask = \
        find_marker_debug2(img, mask_range=(args.diff_min, args.diff_max),dilate_iter=2,k1=(3,3),k2=(15,15))
    ...
    Image.fromarray(value).save(os.path.join(args.debug_dir, "value.png"))
    # plt.clf()
    ...
    Image.fromarray(value_mask).save(os.path.join(args.debug_dir, "value_mask.png"))
    Image.fromarray(mask).save(os.path.join(args.debug_dir, "mask.png"))